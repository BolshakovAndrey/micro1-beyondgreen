...
export const D01_FIXTURE = Object.freeze({
  ...
  verifierOnly: {
    ...
    sourcePaths: [
      ...
      "evaluation/verifier-only/BG-D01/official-runtime-exports.manifest.json",
      "evaluation/verifier-only/BG-D01/official-runtime-exports.ts",
      "evaluation/verifier-only/BG-D01/scenario-provider.manifest.json",
      "evaluation/verifier-only/BG-D01/scenario-provider.ts",
      "evaluation/verifier-only/BG-D01/self-check.test.ts",
    ],
    expectedManifestSha256: "7b896a4fbd8109ce9a391defcf335239fb9d8fcd294af10cbe4ef17ef2b32da4",
    expectedPackageSha256: "84cc797798eccbf95e4cf42f10fc6b44c2887655b0fe57cd2d4f10bae2668e94",
  },
  scripts: {
