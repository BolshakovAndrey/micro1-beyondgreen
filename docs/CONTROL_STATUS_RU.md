...
> **Текущий статусный слой — 2026-08-30 21:22 CEST:** раздел «Актуальное состояние»
> ниже заменяет устаревшие выводы исторического чек-листа. Остальное содержание
> сохраняется как архивный снимок управляющего состояния на 2026-08-29 12:55 CEST и
> не должно использоваться как текущая панель состояния.
